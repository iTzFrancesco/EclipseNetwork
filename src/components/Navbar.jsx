    ...
    <header className="fixed top-0 left-0 right-0 z-50 px-3 md:px-6 pt-3">
      ...
      >
        <div className="glass-card bg-abyss-900/70 backdrop-blur-2xl border-white/10 px-5 md:px-7 py-3.5 md:py-4 relative overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-r from-ocean-500/5 via-transparent to-sea-glow/5 opacity-50 pointer-events-none" />
          ...
          <div className="relative z-10 flex items-center justify-between gap-4">
            ...
            >
              ...
              >
                <p className="text-3xl font-bold">
                   <span className="text-gradient-ocean">Sea</span><span className="text-white">MC</span>
                </p>
              </motion.div>
            </Link>
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="md:hidden inline-flex items-center justify-center h-11 w-11 rounded-xl border border-white/15 bg-white/5 hover:bg-white/10 text-white hover:border-ocean-400/40 transition-all duration-300"
